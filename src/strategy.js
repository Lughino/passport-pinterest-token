 ...
 *
 * The Pinterest authentication strategy authenticates requests by delegating to
 * Pinterest using the OAuth 2.0 protocol.
 *
 ...
 *
 * Options:
 *   - `clientID`      your Pinterest application's client id
 *   - `clientSecret`  your Pinterest application's client secret
 ...
 * @api public
 */
function PinterestTokenStrategy(options, verify) {
  options = options || {};
 ...
 */
util.inherits(PinterestTokenStrategy, OAuth2Strategy);
 ...
 * @api protected
 */
PinterestTokenStrategy.prototype.authenticate = function(req, options) {
  options = options || {};
  var self = this;
 ...
 * @api private
 */
PinterestTokenStrategy.prototype._loadUserProfile = function(accessToken, done) {
  var self = this;
 ...
 */
module.exports = PinterestTokenStrategy;
